...
export const CalendarItem: React.FC<CalentarItemProps> = ({ tasks, onCalendarItemChanged, date, today, active }) => {
    const [completedTasksExist, setCompletedTasksExists] = useState<boolean>(false);
    const [incompletedTasksExist, setIncomletedTasksExists] = useState<boolean>(false);
