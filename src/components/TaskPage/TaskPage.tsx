...
import { updateTask } from 'redux/MainReducer/mainReducer';
import { TaskPageProps } from './TaskPage.interfaces';
import { BaseBtn } from 'controls/BaseBtn/BaseBtn';
import { getTaskData, getTaskId } from 'redux/MainReducer/mainSelectors';
  ...
  return (
    <div className={s.container}>
      ...
      <div className={s.taskName}>
        ...
        {editMode ? (
          <input onChange={onTaskNameChange} value={taskName} />
        ) : (
      ...
      {editMode ? (
        <>
          ...
          <BaseBtn type="primary" onclick={deactivateEditMode}>
            Save
          </BaseBtn>
        </>
      ) : (
        <>
          ...
          <div className={s.btnBox}>
            <BaseBtn type="primary" onclick={activateEditMode}>
              Edit
            </BaseBtn>
